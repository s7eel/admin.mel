...
$query = "SELECT link FROM main, foto WHERE main.id=foto.link_id AND link_id=$id and main_foto_id=\"N\"";
//$query_2 = "SELECT main.id FROM main WHERE title2='2012/02'";
//
//$result2 = $mysqli->query($query_2);
...
<div id="galleryContainer">
	...
	<div id="caption">Арт студия MEL</div>
	<div id="loading">Подождите, пожалуйста...</div>
</div>
